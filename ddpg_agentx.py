...
class Agent():
    ...
    def learn(self, states, actions, rewards, next_states, dones, all_states, all_next_states, all_actions, all_next_actions, gamma):
        ...
        # need to fix
        with torch.no_grad():
            Q_targets_next = self.critic_target(all_next_states, all_next_actions).squeeze() #all_next_states, all_actions_next)
        ...
        #need to fix
        Q_expected = self.critic_local(all_states, all_actions) #states, actions)
